...
function loadLayersStandalone(){
  try{
    const raw=JSON.parse(localStorage.getItem("laceys-copy-layers-layers-v1")||"null");
...
function restoreSnap(s){
  ...
  try{ localStorage.setItem("laceys-copy-layers-layers-v1", JSON.stringify(layers)); }catch(e){}
